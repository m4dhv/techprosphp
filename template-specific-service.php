...
<main class="tp-page-content" style="padding-top: 0; min-height: 80vh;">
  <section style="background: var(--color-primary); padding: 80px 0; position: relative; overflow: hidden;">
    ...
    <div class="container" style="position:relative;z-index:1;">
      <nav style="font-size:0.875rem; color:rgba(255,255,255,0.5); margin-bottom:32px;">
        <a href="<?php echo home_url(); ?>" style="color:rgba(255,255,255,0.5);text-decoration:none;">Home</a> &rsaquo;
        <a href="<?php echo esc_url(home_url('/index.php/our-services')); ?>" style="color:rgba(255,255,255,0.5);text-decoration:none;">Services</a> &rsaquo;
        <span style="color:rgba(255,255,255,0.8);"><?php the_title(); ?></span>
      </nav>
      <span class="label" style="display:inline-block; margin-bottom:16px; color:var(--color-accent);"><?php echo esc_html( get_post_meta( get_the_ID(), 'hero_label', true ) ?: 'know more about our' ); ?></span>
      <h1 style="color:#fff; font-family:var(--font-display); font-size:clamp(2.2rem,3.5vw,3.5rem); margin:0;"><?php the_title(); ?></h1>
...
.tp-hero-banner::after {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(to bottom, rgba(10,15,46,0.50) 0%, rgba(10,15,46,0.08) 45%, rgba(10,15,46,0.08) 60%, rgba(10,15,46,0.40) 100%);
}
...
<div style="background:#fff;">
  <section class="tp-hero-banner">
    <?php if ( has_post_thumbnail() ) :
      ...
      <img src="<?php echo esc_url( get_template_directory_uri() . '/images/hero-default.png' ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>">
    <?php endif; ?>
  </section>
